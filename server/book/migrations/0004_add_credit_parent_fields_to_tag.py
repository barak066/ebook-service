...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tag.credit'
        db.add_column('book_tag', 'credit', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Tag.parent'
        db.add_column('book_tag', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['book.Tag'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tag.credit'
        db.delete_column('book_tag', 'credit')

        # Deleting field 'Tag.parent'
        db.delete_column('book_tag', 'parent_id')
